  ...
  return (
    <div className="relative">
      ...
      <div className="h-screen  opacity-90 bg-gradient-to-br from-slate-900 to-slate-700 flex items-center justify-center flex-col gap-6">
        ...
        <Link
          to={"/sign-up"}
          className="w-2/12 max-lg:w-[340px] flex items-center justify-center  py-3 border border-red-700 bg-red-700 text-white hover:bg-red-900 hover:border-transparent hover:transition-all rounded-lg hover:animate-bounce"
        >
          Logout
        </Link>
      </div>
