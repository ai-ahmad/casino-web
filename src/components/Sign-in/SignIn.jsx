    ...
    axios
      ...
      .then((response) => {
        ...
        if (user) {
          ...
          localStorage.setItem("playerName", JSON.stringify(user.playerName))
          localStorage.setItem("userMoney", JSON.stringify(user.money))
          localStorage.setItem("userCoin", JSON.stringify(user.coin))
